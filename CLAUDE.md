...
**대기와 출전은 한 목록이다.** 따로 두면 배정할 사람을 고를 때 두 곳을 번갈아 봐야 한다 —
덜 뛴 사람이 대기에 있는지가 위쪽에서 안 보인다. 한 줄에 이름·연령대·포지션·뛴 횟수를
같이 놓고 덜 뛴 순으로 세운다. 자리가 다 찼는데 이름을 누르면 **왜 아무 일도 안 일어나는지
말해 준다** — 조용히 넘어가면 앱이 멈춘 줄 안다.
